    ...
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            @if (in_array($user['group_id'], [1, 2, 3]))
                <li>
                    <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Applications<span
            ...
            @if (in_array($user['group_id'], [1, 2, 3]))
                <li>
                    <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Schools & Memberships<span
                            class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
            ...
            @if (in_array($user['group_id'], [1, 5]))
                <li>
                    <a href="#"><i class="fa fa-bus fa-fw"></i>Finance<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="{{ route('portal.bond.index') }}">Browse not accepted bonds</a>
                        </li>
                        <li>
                            <a href="{{ route('portal.request.index') }}">Accept Expense Request</a>
                        </li>
                        <li>
                            <a href="{{ route('portal.request.create') }}">Create Expense Request</a>
                        </li>
                        <li>
                            <a href="{{ route('portal.request.expense.index') }}">Expenses Wallet</a>
                        </li>
                    </ul>
                </li>
            @endif
