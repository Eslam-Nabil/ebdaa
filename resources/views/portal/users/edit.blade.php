...
<div class="panel panel-default panel-body" id="inline-new-user-container">
    <div class="row">
        <form method="post" action="{{ route('portal.users.update', $userData['id']) }}">
            {{ csrf_field() }}
            <div class="col-md-12">
                <div class="col-lg-6">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12 course" style="{{$userData->group_id == 4 ? 'display: block' : 'display: none' }}">
                    <div class="form-group">
                        <label>Courses</label>
